...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-aerospike/node_modules/aerospike/lib/aerospike_error.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-aerospike/node_modules/aerospike/lib/aerospike_error.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-aerospike/node_modules/aerospike/lib/</a> &#187; aerospike_error.js</div>
</div>
<div class="body">
 ...
 * })
 */
<span class="fstat-no" title="function not covered" >function AerospikeError (code, message, func, file, line, stack) {</span>
  /**
   * Error name
   *
   ...
   * @readonly
   */
<span class="cstat-no" title="statement not covered" >  Object.defineProperty(this, 'name', {value: 'AerospikeError'})</span>
&nbsp;
  /**
   * Error message
   *
   ...
   * @readonly
   */
<span class="cstat-no" title="statement not covered" >  this.message = message || 'Aerospike Error'</span>
&nbsp;
  /**
   * Status code.
   *
...
<span class="cstat-no" title="statement not covered" >    stack = stack.replace(/^.*$/m, util.format('%s: %s', this.name, this.message))</span>
<span class="cstat-no" title="statement not covered" >    Object.defineProperty(this, 'stack', {value: stack})</span>
  } else {
<span class="cstat-no" title="statement not covered" >    Error.captureStackTrace(this, this.constructor)</span>
  }
}
&nbsp;
AerospikeError.fromASError = <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >  return new AerospikeError(err.code, err.message, err.func, err.file, err.line, err.stack)</span>
}
&nbsp;
