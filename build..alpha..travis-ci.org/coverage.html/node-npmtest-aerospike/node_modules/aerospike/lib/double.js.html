...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-aerospike/node_modules/aerospike/lib/double.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-aerospike/node_modules/aerospike/lib/double.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-aerospike/node_modules/aerospike/lib/</a> &#187; double.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  if (this instanceof Double) {</span>
<span class="cstat-no" title="statement not covered" >    this.Double = parseFloat(value)</span>
<span class="cstat-no" title="statement not covered" >    if (isNaN(this.Double)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new TypeError('Not a valid Double value')</span>
    }
  } else {
<span class="cstat-no" title="statement not covered" >    return new Double(value)</span>
  }
}
&nbsp;
/**
 ...
 */
Double.prototype.value = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return this.Double</span>
}
&nbsp;
