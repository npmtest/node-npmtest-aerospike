...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-aerospike/node_modules/aerospike/lib/operations.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-aerospike/node_modules/aerospike/lib/operations.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-aerospike/node_modules/aerospike/lib/</a> &#187; operations.js</div>
</div>
<div class="body">
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function Operation (op, bin) {</span>
...
&nbsp;
   ...
   */
  read: <span class="fstat-no" title="function not covered" >function read (bin) {</span>
<span class="cstat-no" title="statement not covered" >    return new Operation(ops.READ, bin)</span>
  },
&nbsp;
  /**
   ...
   * @returns {Object} Operation that can be passed to the {@link Client#operate} command.
   */
  write: <span class="fstat-no" title="function not covered" >function write (bin, value) {</span>
<span class="cstat-no" title="statement not covered" >    var op = new Operation(ops.WRITE, bin)</span>
<span class="cstat-no" title="statement not covered" >    op.value = value</span>
...
&nbsp;
   ...
   * @returns {Object} Operation that can be passed to the {@link Client#operate} command.
   */
  incr: <span class="fstat-no" title="function not covered" >function incr (bin, value) {</span>
<span class="cstat-no" title="statement not covered" >    var op = new Operation(ops.INCR, bin)</span>
<span class="cstat-no" title="statement not covered" >    op.value = value</span>
<span class="cstat-no" title="statement not covered" >    return op</span>
  },
&nbsp;
   ...
   * @returns {Object} Operation that can be passed to the {@link Client#operate} command.
   */
  append: <span class="fstat-no" title="function not covered" >function append (bin, value) {</span>
<span class="cstat-no" title="statement not covered" >    var op = new Operation(ops.APPEND, bin)</span>
<span class="cstat-no" title="statement not covered" >    op.value = value</span>
<span class="cstat-no" title="statement not covered" >    return op</span>
  },
&nbsp;
   ...
   * @returns {Object} Operation that can be passed to the {@link Client#operate} command.
   */
  prepend: <span class="fstat-no" title="function not covered" >function prepend (bin, value) {</span>
<span class="cstat-no" title="statement not covered" >    var op = new Operation(ops.PREPEND, bin)</span>
<span class="cstat-no" title="statement not covered" >    op.value = value</span>
<span class="cstat-no" title="statement not covered" >    return op</span>
  },
&nbsp;
   ...
   */
  touch: <span class="fstat-no" title="function not covered" >function touch (ttl) {</span>
<span class="cstat-no" title="statement not covered" >    var op = new Operation(ops.TOUCH)</span>
<span class="cstat-no" title="statement not covered" >    op.ttl = ttl</span>
<span class="cstat-no" title="statement not covered" >    return op</span>
  }
}
&nbsp;
