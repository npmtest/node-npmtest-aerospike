...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-aerospike/node_modules/aerospike/lib/event_loop.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-aerospike/node_modules/aerospike/lib/event_loop.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-aerospike/node_modules/aerospike/lib/</a> &#187; event_loop.js</div>
</div>
<div class="body">
 ...
 * }
 */
<span class="fstat-no" title="function not covered" >function releaseEventLoop () {</span>
<span class="cstat-no" title="statement not covered" >  _eventLoopReleased = true</span>
<span class="cstat-no" title="statement not covered" >  if (as.get_cluster_count() &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    setTimeout(releaseEventLoop, 5)</span>
  } else {
<span class="cstat-no" title="statement not covered" >    as.release_as_event_loop()</span>
  }
}
&nbsp;
/**
 * @private
 */
<span class="fstat-no" title="function not covered" >function eventLoopReleased () {</span>
<span class="cstat-no" title="statement not covered" >  return _eventLoopReleased</span>
}
&nbsp;
/**
 * @private
 */
<span class="fstat-no" title="function not covered" >function registerASEventLoop () {</span>
<span class="cstat-no" title="statement not covered" >  if (!_eventLoopInitialized) {</span>
<span class="cstat-no" title="statement not covered" >    as.register_as_event_loop()</span>
<span class="cstat-no" title="statement not covered" >    _eventLoopInitialized = true</span>
  }
}
&nbsp;
module.exports = {
